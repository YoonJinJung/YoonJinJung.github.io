      ...
      <main className="container mx-auto px-4 py-8">
        ...
        <section className="grid md:grid-cols-3 gap-6 mb-12">
          <div className="bg-white p-6 rounded-lg shadow-md">
            ...
            <p className="text-gray-600">학생의 수준과 목표에 맞는 1:1 맞춤형 교육을 제공합니다.</p>
          </div>
          <div className="bg-white p-6 rounded-lg shadow-md">
            <h3 className="text-xl font-semibold mb-3">전문 강사진</h3>
            <p className="text-gray-600">현직 개발자 출신의 전문 강사진이 직접 교육합니다.</p>
          </div>
          <div className="bg-white p-6 rounded-lg shadow-md">
            <h3 className="text-xl font-semibold mb-3">체계적 커리큘럼</h3>
            <p className="text-gray-600">기초부터 실전 프로젝트까지 체계적인 커리큘럼을 제공합니다.</p>
          </div>
        </section>
